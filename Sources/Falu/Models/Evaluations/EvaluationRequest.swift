...
public struct EvaluationRequest: Codable {
    ...
    */
    ...
    public init(currency: String, scope: EvaluationScope, provider: StatementProvider, name: String, phone: String? = nil, password: String? = nil, file: Data, fileName: String){
